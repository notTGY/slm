...
def main(max_steps=-1, num_samples=60000, batch_size=32, seq_len=64, epochs=1):
    ...
    model.model.save_pretrained(f"hf-checkpoints/llama-tinystories-{trainer.global_step:06d}")
    tokenizer.save_pretrained(f"hf-checkpoints/llama-tinystories-{trainer.global_step:06d}")
